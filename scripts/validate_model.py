...
Uso:
    python scripts/validate_model.py [--threshold 0.50]
"""
...
def main():
    ...
    # Sem dataset explícito, usa o dataset padrão do Ultralytics.
    if args.dataset:
    ...
    print(
        f"[INFO] mAP@0.5 = {map50:.4f} | "
        f"Limiar: {args.threshold:.4f}"
    )
